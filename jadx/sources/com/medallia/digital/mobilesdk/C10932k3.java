...
public class C10932k3 extends C10717a2<Boolean> {
    protected C10932k3(C11083s0 s0Var) {
        super(s0Var);
    }
    ...
    public CollectorContract mo28118c() {
        return C11195x0.C11196a.f32190Y;
    }

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public void mo28117a(Boolean bool) {
        super.mo28117a(bool);
        C10735b4.m39109b(String.format(Locale.US, "Collectors > set IsOCQRulesValidCollector collector: %s", new Object[]{bool}));
    }
}
