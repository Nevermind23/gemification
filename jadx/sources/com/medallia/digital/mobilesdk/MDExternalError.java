...
public class MDExternalError extends MedalliaDigitalError implements Serializable {
    ...
    /* renamed from: a */
    private static final String f30574a = "Unspecified configuration error";
    ...
    public enum ExternalError {
        ...
        UNSPECIFIED_CONFIGURATION_ERROR_13(10013, MDExternalError.f30574a),
        UNSPECIFIED_CONFIGURATION_ERROR_14(10014, MDExternalError.f30574a),
        UNSPECIFIED_CONFIGURATION_ERROR_15(10015, MDExternalError.f30574a),
        UNSPECIFIED_CONFIGURATION_ERROR_16(10016, MDExternalError.f30574a),
        ...
        TRANSLATION_FEATURE_IS_DISABLED(10051, "Feature is disabled");
