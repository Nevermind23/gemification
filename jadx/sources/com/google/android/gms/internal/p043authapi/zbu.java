...
import p038c7.C2277i;
import p195o6.C7461a;

/* renamed from: com.google.android.gms.internal.auth-api.zbu */
public final class zbu extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zbu> CREATOR = new C2277i();

    /* renamed from: d */
    private final Credential f13070d;

    public zbu(Credential credential) {
        this.f13070d = credential;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = C7461a.m28369a(parcel);
        C7461a.m28390v(parcel, 1, this.f13070d, i, false);
