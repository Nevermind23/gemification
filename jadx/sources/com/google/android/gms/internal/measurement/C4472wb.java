...
abstract class C4472wb {

    /* renamed from: a */
    private static final C4421tb f13787a = new C4438ub();

    /* renamed from: b */
    public static final /* synthetic */ int f13788b = 0;

    static {
        if (C4387rb.m16571C() && C4387rb.m16572D()) {
            int i = C4180f8.f13235a;
        }
    }

    /* renamed from: a */
    static /* bridge */ /* synthetic */ int m17099a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 != 0) {
            if (i3 == 1) {
    ...
    static int m17100b(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        /*
            int r0 = r7.length()
            r1 = 0
        L_0x0005:
        ...
        L_0x00bb:
            r1 = r4
        L_0x00bc:
            com.google.android.gms.internal.measurement.vb r7 = new com.google.android.gms.internal.measurement.vb
            int r1 = r1 + -1
            r7.<init>(r1, r0)
            throw r7
        L_0x00c4:
        ...
        L_0x00ff:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.C4472wb.m17100b(java.lang.CharSequence, byte[], int, int):int");
    }

    /* renamed from: c */
    static int m17101c(CharSequence charSequence) {
    ...
    /* renamed from: d */
    static boolean m17102d(byte[] bArr) {
        return f13787a.mo13650b(bArr, 0, bArr.length);
    }

    /* renamed from: e */
    static boolean m17103e(byte[] bArr, int i, int i2) {
        return f13787a.mo13650b(bArr, i, i2);
    }
}
