...
public abstract class C4698l {
    ...
    static void m17866a(com.google.android.gms.measurement.internal.C4746p3 r10, android.database.sqlite.SQLiteDatabase r11, java.lang.String r12, java.lang.String r13, java.lang.String r14, java.lang.String[] r15) {
        /*
        ...
        L_0x002a:
            ...
            r2 = r1
        L_0x002d:
            com.google.android.gms.measurement.internal.n3 r4 = r10.mo14680w()     // Catch:{ all -> 0x00d8 }
            java.lang.String r5 = "Error querying for table"
            r4.mo14617c(r5, r12, r3)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x00b2:
            ...
            com.google.android.gms.measurement.internal.n3 r11 = r10.mo14680w()     // Catch:{ SQLiteException -> 0x00cd }
            ...
            r11.mo14617c(r14, r12, r13)     // Catch:{ SQLiteException -> 0x00cd }
        L_0x00c7:
            return
        L_0x00c8:
            r11 = move-exception
        ...
        L_0x00cd:
            r11 = move-exception
            com.google.android.gms.measurement.internal.n3 r10 = r10.mo14675r()
            java.lang.String r13 = "Failed to verify columns on table that was just created"
            r10.mo14616b(r13, r12)
            throw r11
        L_0x00d8:
            r10 = move-exception
            r1 = r2
        ...
        L_0x00e0:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4698l.m17866a(com.google.android.gms.measurement.internal.p3, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    static void m17867b(C4746p3 p3Var, SQLiteDatabase sQLiteDatabase) {
        if (p3Var != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                p3Var.mo14680w().mo14615a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                p3Var.mo14680w().mo14615a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                p3Var.mo14680w().mo14615a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                p3Var.mo14680w().mo14615a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
