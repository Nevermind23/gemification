...
public final class C4680j3 extends C4801u3 {

    /* renamed from: c */
    private final C4669i3 f14534c;

    /* renamed from: d */
    private boolean f14535d;

    C4680j3(C4791t4 t4Var) {
        super(t4Var);
        Context c = this.f14613a.mo14550c();
        this.f14613a.mo14876z();
        this.f14534c = new C4669i3(this, c, "google_app_measurement_local.db");
    }
    ...
    private final boolean m17793x(int r17, byte[] r18) {
        /*
            r16 = this;
            r1 = r16
            r16.mo14554h()
            boolean r0 = r1.f14535d
            r2 = 0
        ...
        L_0x0028:
            ...
            r7 = 1
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r16.mo14475o()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c2, all -> 0x00bf }
            if (r9 != 0) goto L_0x0035
            r1.f14535d = r7     // Catch:{ SQLiteFullException -> 0x00bb, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x00b7 }
            return r2
        L_0x0035:
        ...
        L_0x0054:
            ...
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            java.lang.String r4 = "Data loss, local db full"
            r0.mo14615a(r4)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            long r13 = r13 - r11
            ...
            r0.mo14618d(r4, r2, r7, r11)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
        L_0x009f:
        ...
        L_0x00cf:
            com.google.android.gms.measurement.internal.t4 r2 = r1.f14613a     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.p3 r2 = r2.mo14551d()     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.n3 r2 = r2.mo14675r()     // Catch:{ all -> 0x011f }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo14616b(r4, r0)     // Catch:{ all -> 0x011f }
            r2 = 1
            r1.f14535d = r2     // Catch:{ all -> 0x011f }
        ...
        L_0x012d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4680j3.m17793x(int, byte[]):boolean");
    }
    ...
    /* renamed from: o */
    public final SQLiteDatabase mo14475o() {
        if (this.f14535d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f14534c.getWritableDatabase();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r1.f14613a.mo14551d().mo14675r().mo14615a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        r1.f14613a.mo14551d().mo14675r().mo14615a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:?, code lost:
        r1.f14613a.mo14551d().mo14675r().mo14615a("Failed to load conditional user property from local database");
     */
    ...
    /* renamed from: p */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List mo14476p(int r23) {
        /*
            r22 = this;
            r1 = r22
        ...
        L_0x001e:
            ...
            r10 = 1
            android.database.sqlite.SQLiteDatabase r15 = r22.mo14475o()     // Catch:{ SQLiteFullException -> 0x022e, SQLiteDatabaseLockedException -> 0x021b, SQLiteException -> 0x01f6, all -> 0x01f3 }
            if (r15 != 0) goto L_0x002a
            r1.f14535d = r10     // Catch:{ SQLiteFullException -> 0x01ee, SQLiteDatabaseLockedException -> 0x01ea, SQLiteException -> 0x01e5, all -> 0x01e0 }
            return r4
        L_0x002a:
        ...
        L_0x00c0:
            ...
            goto L_0x00d5
        L_0x00c2:
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ all -> 0x00c0 }
            java.lang.String r13 = "Failed to load event from local database"
            r0.mo14615a(r13)     // Catch:{ all -> 0x00c0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x00d5:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x00d9:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzlj> r0 = com.google.android.gms.measurement.internal.zzlj.CREATOR     // Catch:{ ParseException -> 0x00f4 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ ParseException -> 0x00f4 }
            com.google.android.gms.measurement.internal.zzlj r0 = (com.google.android.gms.measurement.internal.zzlj) r0     // Catch:{ ParseException -> 0x00f4 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x0107
        L_0x00f2:
            r0 = move-exception
            goto L_0x010d
        L_0x00f4:
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ all -> 0x00f2 }
            java.lang.String r13 = "Failed to load user property from local database"
            r0.mo14615a(r13)     // Catch:{ all -> 0x00f2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x0107:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x012a:
            ...
            goto L_0x0146
        L_0x012c:
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ all -> 0x012a }
            java.lang.String r13 = "Failed to load conditional user property from local database"
            r0.mo14615a(r13)     // Catch:{ all -> 0x012a }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x013f:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x014a:
            ...
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14680w()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            java.lang.String r12 = "Skipping app launch break"
            r0.mo14615a(r12)     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x015e:
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x016f:
            ...
            com.google.android.gms.measurement.internal.t4 r0 = r1.f14613a     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.p3 r0 = r0.mo14551d()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.n3 r0 = r0.mo14675r()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            java.lang.String r12 = "Fewer entries removed from local database than expected"
            r0.mo14615a(r12)     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
        L_0x0196:
        ...
        L_0x0204:
            com.google.android.gms.measurement.internal.t4 r12 = r1.f14613a     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.p3 r12 = r12.mo14551d()     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.n3 r12 = r12.mo14675r()     // Catch:{ all -> 0x024c }
            r12.mo14616b(r3, r0)     // Catch:{ all -> 0x024c }
            r1.f14535d = r10     // Catch:{ all -> 0x024c }
        ...
        L_0x0269:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4680j3.mo14476p(int):java.util.List");
    }

    /* renamed from: q */
    public final void mo14477q() {
        int delete;
        mo14554h();
        try {
            SQLiteDatabase o = mo14475o();
            if (o != null && (delete = o.delete(C11769i.f34134e, (String) null, (String[]) null)) > 0) {
                this.f14613a.mo14551d().mo14679v().mo14616b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            this.f14613a.mo14551d().mo14675r().mo14616b("Error resetting local analytics data. error", e);
        }
    }

    /* renamed from: r */
    public final boolean mo14478r() {
        return m17793x(3, new byte[0]);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: s */
    public final boolean mo14479s() {
        Context c = this.f14613a.mo14550c();
        this.f14613a.mo14876z();
    ...
    /* renamed from: t */
    public final boolean mo14480t() {
        mo14554h();
        if (!this.f14535d && mo14479s()) {
            int i = 5;
            int i2 = 0;
            while (i2 < 5) {
                ...
                try {
                    ...
                    o.beginTransaction();
                    o.delete(C11769i.f34134e, "type == ?", new String[]{Integer.toString(3)});
                    o.setTransactionSuccessful();
                    o.endTransaction();
                    o.close();
                    return true;
                } catch (SQLiteFullException e) {
                    this.f14613a.mo14551d().mo14675r().mo14616b("Error deleting app launch break from local database", e);
                    this.f14535d = true;
                    ...
                    this.f14613a.mo14551d().mo14675r().mo14616b("Error deleting app launch break from local database", e2);
                    this.f14535d = true;
                    if (sQLiteDatabase != null) {
                        sQLiteDatabase.close();
                        i2++;
            ...
            this.f14613a.mo14551d().mo14680w().mo14615a("Error deleting app launch break from local database in reasonable time");
        }
        return false;
    }

    /* renamed from: u */
    public final boolean mo14481u(zzac zzac) {
        byte[] e0 = this.f14613a.mo14856N().mo14818e0(zzac);
        if (e0.length <= 131072) {
            return m17793x(2, e0);
        }
        this.f14613a.mo14551d().mo14677t().mo14615a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: v */
    public final boolean mo14482v(zzaw zzaw) {
        Parcel obtain = Parcel.obtain();
        C4786t.m18284a(zzaw, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m17793x(0, marshall);
        }
        this.f14613a.mo14551d().mo14677t().mo14615a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: w */
    public final boolean mo14483w(zzlj zzlj) {
        Parcel obtain = Parcel.obtain();
        C4752p9.m18174a(zzlj, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m17793x(1, marshall);
        }
        this.f14613a.mo14551d().mo14677t().mo14615a("User property too long for local database. Sending directly to service");
        return false;
    }
}
