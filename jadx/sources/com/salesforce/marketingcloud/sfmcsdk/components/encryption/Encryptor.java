...
class Encryptor {
    ...
    private static Cipher getDecryptingCipher(byte[] bArr, byte[] bArr2) {
    ...
    private static Cipher getEncryptingCipher(byte[] bArr, byte[] bArr2) {
        Cipher bestCipher = getBestCipher(AES_GCM_CIPHER);
        SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, bestCipher.getAlgorithm());
        IvParameterSpec ivParameterSpec = new IvParameterSpec(bArr2);
    ...
    private static Cipher getLegacyDecryptingCipher(byte[] bArr, byte[] bArr2) {
    ...
    private static byte[] decrypt(byte[] bArr, int i, byte[] bArr2, byte[] bArr3) {
        Cipher cipher;
