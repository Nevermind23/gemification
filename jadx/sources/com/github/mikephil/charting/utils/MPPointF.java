...
public class MPPointF extends ObjectPool.Poolable {
    ...
    /* renamed from: x */
    public float f11822x;

    /* renamed from: y */
    public float f11823y;
    ...
    public void my_readFromParcel(Parcel parcel) {
        this.f11822x = parcel.readFloat();
        this.f11823y = parcel.readFloat();
    }
    ...
    public static MPPointF getInstance(MPPointF mPPointF) {
        ...
        mPPointF2.f11822x = mPPointF.f11822x;
        mPPointF2.f11823y = mPPointF.f11823y;
        return mPPointF2;
    }
}
