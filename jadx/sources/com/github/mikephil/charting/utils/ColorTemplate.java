...
public class ColorTemplate {
    public static final int[] COLORFUL_COLORS = {Color.rgb(193, 37, 82), Color.rgb(C11051p3.f31759c, 102, 0), Color.rgb(245, 199, 0), Color.rgb(106, 150, 31), Color.rgb(179, 100, 53)};
    ...
    public static final int[] LIBERTY_COLORS = {Color.rgb(207, 248, 246), Color.rgb(148, 212, 212), Color.rgb(136, SubsamplingScaleImageView.ORIENTATION_180, 187), Color.rgb(118, 174, 175), Color.rgb(42, 109, 130)};
    ...
    public static final int[] VORDIPLOM_COLORS = {Color.rgb(192, C11051p3.f31759c, 140), Color.rgb(C11051p3.f31759c, 247, 140), Color.rgb(C11051p3.f31759c, 208, 140), Color.rgb(140, 234, C11051p3.f31759c), Color.rgb(C11051p3.f31759c, 140, 157)};

    public static int colorWithAlpha(int i, int i2) {
        return (i & 16777215) | ((i2 & C11051p3.f31759c) << 24);
    }
    ...
    public static int rgb(String str) {
        ...
        return Color.rgb((parseLong >> 16) & C11051p3.f31759c, (parseLong >> 8) & C11051p3.f31759c, (parseLong >> 0) & C11051p3.f31759c);
    }
