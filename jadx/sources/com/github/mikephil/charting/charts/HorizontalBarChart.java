...
public class HorizontalBarChart extends BarChart {
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f11821y);
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f11821y);
    }
