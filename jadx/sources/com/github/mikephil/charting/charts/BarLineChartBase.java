...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    static /* synthetic */ class C37622 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f11796x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f11795x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f11795x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f11797xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.BarLineChartBase.C37622.<clinit>():void");
        }
    }
    ...
    public void calculateLegendOffsets(RectF rectF) {
        ...
        if (legend != null && legend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C37622.f11796x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C37622.f11795x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C37622.f11797xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C37622.f11797xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    rectF.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - (scaleX / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f11820x, (float) valuesByTouchPoint.f11821y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }

    public void centerViewToY(float f, YAxis.AxisDependency axisDependency) {
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, Utils.FLOAT_EPSILON, f + ((getAxisRange(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this));
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f11820x);
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f11820x);
    }
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        MPPointD valuesByTouchPoint = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axisDependency);
        float axisRange = getAxisRange(axisDependency) / this.mViewPortHandler.getScaleY();
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f11820x, (float) valuesByTouchPoint.f11821y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }

    public void moveViewToX(float f) {
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, f, Utils.FLOAT_EPSILON, getTransformer(YAxis.AxisDependency.LEFT), this));
    }
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency2), getAxis(axisDependency2), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f11820x, (float) valuesByTouchPoint.f11821y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }

    public void zoomIn() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomIn(contentCenter.f11822x, -contentCenter.f11823y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f11822x, -contentCenter.f11823y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f11822x, -centerOffsets.f11823y, matrix);
        this.mViewPortHandler.refresh(matrix, this, false);
    }
