...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(this.mViewPortHandler.contentLeft(), (float) pixelForValues.f11821y);
        path.lineTo(this.mViewPortHandler.contentRight(), (float) pixelForValues.f11821y);
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float calcTextHeight = (((float) Utils.calcTextHeight(this.mAxisLabelPaint, PensionStatusResult.STATUS_ACTIVE)) / 2.5f) + this.mYAxis.getYOffset();
