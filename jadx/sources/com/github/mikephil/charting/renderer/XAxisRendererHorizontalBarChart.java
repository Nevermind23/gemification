...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentWidth() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutY()) {
            ...
            if (z) {
                f3 = (float) valuesByTouchPoint2.f11821y;
                d = valuesByTouchPoint.f11821y;
            } else {
                f3 = (float) valuesByTouchPoint.f11821y;
                d = valuesByTouchPoint2.f11821y;
            }
    ...
    public void drawLabels(Canvas canvas, float f, MPPointF mPPointF) {
        ...
        for (int i3 = 0; i3 < i; i3 += 2) {
            ...
            if (this.mViewPortHandler.isInBoundsY(f2)) {
                ...
                XAxis xAxis = this.mXAxis;
                drawLabel(canvas, valueFormatter.getAxisLabel(xAxis.mEntries[i3 / 2], xAxis), f, f2, mPPointF, labelRotationAngle);
            }
        }
    }
