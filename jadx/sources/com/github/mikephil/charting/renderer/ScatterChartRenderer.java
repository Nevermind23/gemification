        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iScatterDataSet != null && iScatterDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iScatterDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f11820x, (float) pixelForValues.f11821y, iScatterDataSet);
                }
            }
        }
    }
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(generateTransformedValuesScatter[i2])) {
                            ...
                            if (this.mViewPortHandler.isInBoundsY(generateTransformedValuesScatter[i3])) {
                                ...
                                if (entry.getIcon() != null && iScatterDataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(canvas, icon, (int) (generateTransformedValuesScatter[i2] + instance.f11822x), (int) (generateTransformedValuesScatter[i3] + instance.f11823y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                                i2 += 2;
