...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentHeight() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (!z) {
                f3 = (float) valuesByTouchPoint.f11820x;
                d = valuesByTouchPoint2.f11820x;
            } else {
                f3 = (float) valuesByTouchPoint2.f11820x;
                d = valuesByTouchPoint.f11820x;
            }
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f11820x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f11820x) - 1.0f, this.mViewPortHandler.contentBottom());
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            if (axisDependency == YAxis.AxisDependency.LEFT) {
                ...
                f = f2 + calcTextHeight + convertDpToPixel;
            }
