...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public RadarChartRenderer(RadarChart radarChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.mHighlightPaint.setColor(Color.rgb(C11051p3.f31759c, 187, 115));
    ...
    public void drawDataSet(Canvas canvas, IRadarDataSet iRadarDataSet, int i) {
        ...
        for (int i2 = 0; i2 < iRadarDataSet.getEntryCount(); i2++) {
            ...
            if (!Float.isNaN(instance.f11822x)) {
                if (!z) {
                    path.moveTo(instance.f11822x, instance.f11823y);
                    z = true;
                } else {
                    path.lineTo(instance.f11822x, instance.f11823y);
                }
            }
        }
        if (iRadarDataSet.getEntryCount() > i) {
            path.lineTo(centerOffsets.f11822x, centerOffsets.f11823y);
        }
        path.close();
    ...
    public void drawHighlightCircle(Canvas canvas, MPPointF mPPointF, float f, float f2, int i, int i2, float f3) {
        ...
        if (i != 1122867) {
            ...
            path.reset();
            path.addCircle(mPPointF.f11822x, mPPointF.f11823y, convertDpToPixel, Path.Direction.CW);
            if (convertDpToPixel2 > Utils.FLOAT_EPSILON) {
                path.addCircle(mPPointF.f11822x, mPPointF.f11823y, convertDpToPixel2, Path.Direction.CCW);
            }
        ...
        if (i2 != 1122867) {
            ...
            canvas.drawCircle(mPPointF.f11822x, mPPointF.f11823y, convertDpToPixel, this.mHighlightCirclePaint);
        }
        canvas.restore();
    }
        ...
        while (i4 < length) {
            ...
            if (iRadarDataSet != null && iRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(radarEntry, iRadarDataSet)) {
                    ...
                    highlight.setDraw(instance.f11822x, instance.f11823y);
                    drawHighlightLines(canvas, instance.f11822x, instance.f11823y, iRadarDataSet);
                    if (iRadarDataSet.isDrawHighlightCircleEnabled() && !Float.isNaN(instance.f11822x) && !Float.isNaN(instance.f11823y)) {
    ...
    public void drawValues(Canvas canvas) {
        ...
        while (i4 < ((RadarData) this.mChart.getData()).getDataSetCount()) {
            ...
            if (!shouldDrawValues(iRadarDataSet2)) {
                ...
                instance3.f11822x = Utils.convertDpToPixel(instance3.f11822x);
                instance3.f11823y = Utils.convertDpToPixel(instance3.f11823y);
                int i5 = 0;
                while (i5 < iRadarDataSet2.getEntryCount()) {
                    ...
                    if (iRadarDataSet2.isDrawValuesEnabled()) {
                        ...
                        float f4 = instance.f11822x;
                        radarEntry = radarEntry2;
                        float f5 = instance.f11823y - convertDpToPixel;
                    ...
                    if (radarEntry.getIcon() != null && iRadarDataSet.isDrawIconsEnabled()) {
                        ...
                        Utils.getPosition(centerOffsets, (radarEntry.getY() * factor * phaseY) + mPPointF.f11823y, f3 + this.mChart.getRotationAngle(), instance2);
                        float f8 = instance2.f11823y + mPPointF.f11822x;
                        instance2.f11823y = f8;
                        Utils.drawImage(canvas, icon, (int) instance2.f11822x, (int) f8, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                    }
                    i5 = i2 + 1;
                    instance3 = mPPointF;
    ...
    public void drawWeb(Canvas canvas) {
        ...
        for (int i = 0; i < entryCount; i += skipWebLineCount) {
            ...
            canvas.drawLine(centerOffsets.f11822x, centerOffsets.f11823y, instance.f11822x, instance.f11823y, this.mWebPaint);
        }
        MPPointF.recycleInstance(instance);
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            while (i4 < ((RadarData) this.mChart.getData()).getEntryCount()) {
                ...
                canvas.drawLine(instance2.f11822x, instance2.f11823y, instance3.f11822x, instance3.f11823y, this.mWebPaint);
            }
        }
        MPPointF.recycleInstance(instance2);
        MPPointF.recycleInstance(instance3);
