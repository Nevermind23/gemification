...
/* renamed from: va.a */
public abstract class C8718a {

    /* renamed from: a */
    private static final TimeZone f24532a = DesugarTimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static boolean m32469a(String str, int i, char c) {
        return i < str.length() && str.charAt(i) == c;
    }

    /* renamed from: b */
    private static int m32470b(String str, int i) {
        while (i < str.length()) {
    ...
    public static java.util.Date m32471c(java.lang.String r17, java.text.ParsePosition r18) {
        /*
            r1 = r17
            r2 = r18
            int r0 = r18.getIndex()     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            int r3 = r0 + 4
            int r0 = m32472d(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            r4 = 45
            boolean r5 = m32469a(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = m32472d(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            boolean r6 = m32469a(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = m32472d(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            r7 = 84
            boolean r7 = m32469a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            r8 = 0
            r9 = 1
        ...
        L_0x004d:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = m32472d(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            r13 = 58
            boolean r14 = m32469a(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            if (r14 == 0) goto L_0x0066
            int r7 = r7 + 1
        L_0x0066:
            int r14 = r7 + 2
            int r7 = m32472d(r1, r7, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            boolean r13 = m32469a(r1, r14, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
        ...
        L_0x0074:
            ...
            int r13 = r14 + 2
            int r14 = m32472d(r1, r14, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            r15 = 59
        ...
        L_0x0094:
            r15 = 46
            boolean r15 = m32469a(r1, r13, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            if (r15 == 0) goto L_0x00bf
            int r13 = r13 + 1
            int r15 = r13 + 1
            int r15 = m32470b(r1, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            int r8 = r13 + 3
            ...
            int r16 = m32472d(r1, r13, r8)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            int r8 = r8 - r13
        ...
        L_0x00cd:
            ...
            java.util.TimeZone r4 = f24532a     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            int r6 = r6 + r9
            goto L_0x0187
        L_0x00df:
        ...
        L_0x0132:
            ...
            r10.append(r4)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            java.lang.String r4 = r10.toString()     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
            java.util.TimeZone r10 = p342j$.util.DesugarTimeZone.getTimeZone(r4)     // Catch:{ IndexOutOfBoundsException -> 0x01c4, NumberFormatException -> 0x01c2, IllegalArgumentException -> 0x01c0 }
        ...
        L_0x0207:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p290va.C8718a.m32471c(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: d */
    private static int m32472d(String str, int i, int i2) {
        int i3;
        int i4;
