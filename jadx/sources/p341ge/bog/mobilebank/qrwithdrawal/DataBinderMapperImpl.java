package p341ge.bog.mobilebank.qrwithdrawal;
...
/* renamed from: ge.bog.mobilebank.qrwithdrawal.DataBinderMapperImpl */
public class DataBinderMapperImpl extends C1358e {

    /* renamed from: a */
    private static final SparseIntArray f83337a = new SparseIntArray(0);
    ...
    public ViewDataBinding mo3888b(C1359f fVar, View view, int i) {
        if (f83337a.get(i) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public ViewDataBinding mo3889c(C1359f fVar, View[] viewArr, int i) {
        if (viewArr == null || viewArr.length == 0 || f83337a.get(i) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
