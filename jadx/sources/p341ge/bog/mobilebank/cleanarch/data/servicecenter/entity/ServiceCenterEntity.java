package p341ge.bog.mobilebank.cleanarch.data.servicecenter.entity;
...
@Keep
/* renamed from: ge.bog.mobilebank.cleanarch.data.servicecenter.entity.ServiceCenterEntity */
public final class ServiceCenterEntity {
    private final String customerType;
    private final String hasSoloSc;

    /* renamed from: id */
    private final long f56458id;
    ...
    public static /* synthetic */ ServiceCenterEntity copy$default(ServiceCenterEntity serviceCenterEntity, long j, long j2, String str, String str2, String str3, String str4, String str5, String str6, List list, int i, Object obj) {
        ...
        int i2 = i;
        return serviceCenterEntity.copy((i2 & 1) != 0 ? serviceCenterEntity2.f56458id : j, (i2 & 2) != 0 ? serviceCenterEntity2.parentId : j2, (i2 & 4) != 0 ? serviceCenterEntity2.langCode : str, (i2 & 8) != 0 ? serviceCenterEntity2.pointType : str2, (i2 & 16) != 0 ? serviceCenterEntity2.pointValue : str3, (i2 & 32) != 0 ? serviceCenterEntity2.pointDesc : str4, (i2 & 64) != 0 ? serviceCenterEntity2.hasSoloSc : str5, (i2 & 128) != 0 ? serviceCenterEntity2.customerType : str6, (i2 & C11398b.f33139r) != 0 ? serviceCenterEntity2.points : list);
    }

    public final long component1() {
        return this.f56458id;
    }
    ...
    public int hashCode() {
        int a = ((((((((C7397t.m28148a(this.f56458id) * 31) + C7397t.m28148a(this.parentId)) * 31) + this.langCode.hashCode()) * 31) + this.pointType.hashCode()) * 31) + this.pointValue.hashCode()) * 31;
