...
@Keep
/* renamed from: ge.bog.mobilebank.autoliabilityinsurance.data.model.PolicyApiModel */
public final class PolicyApiModel {
    ...
    public PolicyApiModel(long j, long j2, String str, String str2, String str3, BigDecimal bigDecimal, String str4, BigDecimal bigDecimal2, String str5, long j3, long j4, long j5, String str6, long j6, String str7, String str8, String str9, long j7, String str10, YesNoApiEntity yesNoApiEntity, String str11, String str12, String str13, String str14, String str15, String str16, boolean z) {
        String str17 = str;
        String str18 = str2;
        String str19 = str3;
        ...
        C41536l.m120489i(bigDecimal3, "insLimit");
        C41536l.m120489i(str20, "insLimitCcy");
        C41536l.m120489i(bigDecimal4, "insPremium");
        C41536l.m120489i(str21, "insPremiumCcy");
        C41536l.m120489i(str22, "payPeriod");
        C41536l.m120489i(str23, "carOwnerFirstName");
        C41536l.m120489i(str24, "carOwnerLastName");
        C41536l.m120489i(str25, "carOwnerPin");
        C41536l.m120489i(str26, "carNumber");
        ...
        this.policyNo = str19;
        this.insLimit = bigDecimal3;
        this.insLimitCcy = str20;
        this.insPremium = bigDecimal4;
        this.insPremiumCcy = str21;
        this.policyCreateDate = j3;
        this.policyStartDate = j4;
        this.policyEndDate = j5;
        this.payPeriod = str22;
        this.policyFileId = j6;
        this.carOwnerFirstName = str23;
        this.carOwnerLastName = str24;
        this.carOwnerPin = str25;
        this.carOwnerBirthDate = j7;
        ...
        this.providerPhone = str14;
        this.policyPdfUrl = str15;
    ...
    public static /* synthetic */ PolicyApiModel copy$default(PolicyApiModel policyApiModel, long j, long j2, String str, String str2, String str3, BigDecimal bigDecimal, String str4, BigDecimal bigDecimal2, String str5, long j3, long j4, long j5, String str6, long j6, String str7, String str8, String str9, long j7, String str10, YesNoApiEntity yesNoApiEntity, String str11, String str12, String str13, String str14, String str15, String str16, boolean z, int i, Object obj) {
        ...
        int i2 = i;
        long j8 = (i2 & 1) != 0 ? policyApiModel2.docKey : j;
        long j9 = (i2 & 2) != 0 ? policyApiModel2.clientKey : j2;
        String str17 = (i2 & 4) != 0 ? policyApiModel2.providerId : str;
        String str18 = (i2 & 8) != 0 ? policyApiModel2.productType : str2;
        String str19 = (i2 & 16) != 0 ? policyApiModel2.policyNo : str3;
        BigDecimal bigDecimal3 = (i2 & 32) != 0 ? policyApiModel2.insLimit : bigDecimal;
        String str20 = (i2 & 64) != 0 ? policyApiModel2.insLimitCcy : str4;
        BigDecimal bigDecimal4 = (i2 & 128) != 0 ? policyApiModel2.insPremium : bigDecimal2;
        String str21 = (i2 & C11398b.f33139r) != 0 ? policyApiModel2.insPremiumCcy : str5;
        long j12 = (i2 & C11398b.f33140s) != 0 ? policyApiModel2.policyCreateDate : j3;
        long j13 = (i2 & C11398b.f33141t) != 0 ? policyApiModel2.policyStartDate : j4;
        long j14 = (i2 & C11398b.f33142u) != 0 ? policyApiModel2.policyEndDate : j5;
        return policyApiModel.copy(j8, j9, str17, str18, str19, bigDecimal3, str20, bigDecimal4, str21, j12, j13, j14, (i2 & C11398b.f33143v) != 0 ? policyApiModel2.payPeriod : str6, (i2 & 8192) != 0 ? policyApiModel2.policyFileId : j6, (i2 & 16384) != 0 ? policyApiModel2.carOwnerFirstName : str7, (i2 & 32768) != 0 ? policyApiModel2.carOwnerLastName : str8, (i2 & 65536) != 0 ? policyApiModel2.carOwnerPin : str9, (i2 & 131072) != 0 ? policyApiModel2.carOwnerBirthDate : j7, (i2 & 262144) != 0 ? policyApiModel2.carNumber : str10, (524288 & i2) != 0 ? policyApiModel2.directDebitStatus : yesNoApiEntity, (i2 & 1048576) != 0 ? policyApiModel2.productName : str11, (i2 & 2097152) != 0 ? policyApiModel2.providerName : str12, (i2 & 4194304) != 0 ? policyApiModel2.providerLogoUrl : str13, (i2 & 8388608) != 0 ? policyApiModel2.providerPhone : str14, (i2 & 16777216) != 0 ? policyApiModel2.policyPdfUrl : str15, (i2 & 33554432) != 0 ? policyApiModel2.paymentPeriodName : str16, (i2 & 67108864) != 0 ? policyApiModel2.isOwnersCar : z);
    }
    ...
    public final PolicyApiModel copy(long j, long j2, String str, String str2, String str3, BigDecimal bigDecimal, String str4, BigDecimal bigDecimal2, String str5, long j3, long j4, long j5, String str6, long j6, String str7, String str8, String str9, long j7, String str10, YesNoApiEntity yesNoApiEntity, String str11, String str12, String str13, String str14, String str15, String str16, boolean z) {
        ...
        C41536l.m120489i(bigDecimal, "insLimit");
        C41536l.m120489i(str4, "insLimitCcy");
        C41536l.m120489i(bigDecimal2, "insPremium");
        C41536l.m120489i(str5, "insPremiumCcy");
        ...
        C41536l.m120489i(str15, "policyPdfUrl");
        C41536l.m120489i(str16, "paymentPeriodName");
        return new PolicyApiModel(j, j2, str, str2, str3, bigDecimal, str4, bigDecimal2, str5, j3, j4, j5, str6, j6, str7, str8, str9, j7, str10, yesNoApiEntity, str11, str12, str13, str14, str15, str16, z);
    }
    ...
    public int hashCode() {
        int a = ((((((((((((((((((((((((((((((((((((((((((C7397t.m28148a(this.docKey) * 31) + C7397t.m28148a(this.clientKey)) * 31) + this.providerId.hashCode()) * 31) + this.productType.hashCode()) * 31) + this.policyNo.hashCode()) * 31) + this.insLimit.hashCode()) * 31) + this.insLimitCcy.hashCode()) * 31) + this.insPremium.hashCode()) * 31) + this.insPremiumCcy.hashCode()) * 31) + C7397t.m28148a(this.policyCreateDate)) * 31) + C7397t.m28148a(this.policyStartDate)) * 31) + C7397t.m28148a(this.policyEndDate)) * 31) + this.payPeriod.hashCode()) * 31) + C7397t.m28148a(this.policyFileId)) * 31) + this.carOwnerFirstName.hashCode()) * 31) + this.carOwnerLastName.hashCode()) * 31) + this.carOwnerPin.hashCode()) * 31) + C7397t.m28148a(this.carOwnerBirthDate)) * 31) + this.carNumber.hashCode()) * 31) + this.directDebitStatus.hashCode()) * 31) + this.productName.hashCode()) * 31) + this.providerName.hashCode()) * 31;
        String str = this.providerLogoUrl;
        int hashCode = (((((((a + (str == null ? 0 : str.hashCode())) * 31) + this.providerPhone.hashCode()) * 31) + this.policyPdfUrl.hashCode()) * 31) + this.paymentPeriodName.hashCode()) * 31;
