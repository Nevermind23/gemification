...
public final class PasscodeLoginQuery implements C7842i {
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    public static final String OPERATION_ID = "aa40cbbe936f38756298f8efa0d155c8bc0265b05248ab59861edcce1d848b62";
    /* access modifiers changed from: private */
    public static final C7841h OPERATION_NAME = new PasscodeLoginQuery$Companion$OPERATION_NAME$1();
    /* access modifiers changed from: private */
    public static final String QUERY_DOCUMENT = C8118k.m30683a("query passcodeLoginQuery($username:String!, $passcode: String!, $authToken:String!, $deviceId:String!, $processReference: String!, $tmxSessionId: String!) {\n  loginServices {\n    __typename\n    login(request: {username: $username, passcode: $passcode, authToken: $authToken, deviceId: $deviceId, processReference: $processReference, tmxSessionId: $tmxSessionId}) {\n      __typename\n      ...loginInfo\n    }\n  }\n}\nfragment loginInfo on LoginResponseContent {\n  __typename\n  isChannelActive\n  isPasswordExpired\n  isUsernameChangeRequired\n  passwordChangeRequired\n  processReference\n}");
    ...
    private final transient C7836g.C7839c variables = new PasscodeLoginQuery$variables$1(this);
    ...
    public static final class Companion {
        ...
        public final C7841h getOPERATION_NAME() {
            return PasscodeLoginQuery.OPERATION_NAME;
        }

        public final String getQUERY_DOCUMENT() {
            return PasscodeLoginQuery.QUERY_DOCUMENT;
        }
    }
    ...
    public static final class Data implements C7836g.C7838b {
        ...
        public static final class Companion {
            ...
            public final C8120m Mapper() {
                ...
                return new PasscodeLoginQuery$Data$Companion$Mapper$$inlined$invoke$1();
            }

            public final Data invoke(C8124o oVar) {
                C41536l.m120489i(oVar, "reader");
                return new Data((LoginServices) oVar.mo19023f(Data.RESPONSE_FIELDS[0], PasscodeLoginQuery$Data$Companion$invoke$1$loginServices$1.INSTANCE));
            }
        }
        ...
        public C8122n marshaller() {
            ...
            return new PasscodeLoginQuery$Data$marshaller$$inlined$invoke$1(this);
        }
    ...
    public PasscodeLoginQuery(String str, String str2, String str3, String str4, String str5, String str6) {
        C41536l.m120489i(str, "username");
        C41536l.m120489i(str2, "passcode");
        C41536l.m120489i(str3, "authToken");
        C41536l.m120489i(str4, "deviceId");
        C41536l.m120489i(str5, "processReference");
        C41536l.m120489i(str6, "tmxSessionId");
        this.username = str;
        this.passcode = str2;
        this.authToken = str3;
        this.deviceId = str4;
        this.processReference = str5;
        this.tmxSessionId = str6;
    }

    public static /* synthetic */ PasscodeLoginQuery copy$default(PasscodeLoginQuery passcodeLoginQuery, String str, String str2, String str3, String str4, String str5, String str6, int i, Object obj) {
        if ((i & 1) != 0) {
            str = passcodeLoginQuery.username;
        }
        if ((i & 2) != 0) {
            str2 = passcodeLoginQuery.passcode;
        }
        String str7 = str2;
        if ((i & 4) != 0) {
            str3 = passcodeLoginQuery.authToken;
        }
        String str8 = str3;
        if ((i & 8) != 0) {
            str4 = passcodeLoginQuery.deviceId;
        }
        String str9 = str4;
        if ((i & 16) != 0) {
            str5 = passcodeLoginQuery.processReference;
        }
        String str10 = str5;
        if ((i & 32) != 0) {
            str6 = passcodeLoginQuery.tmxSessionId;
        }
        return passcodeLoginQuery.copy(str, str7, str8, str9, str10, str6);
    }
    ...
    public final PasscodeLoginQuery copy(String str, String str2, String str3, String str4, String str5, String str6) {
        C41536l.m120489i(str, "username");
        C41536l.m120489i(str2, "passcode");
        C41536l.m120489i(str3, "authToken");
        C41536l.m120489i(str4, "deviceId");
        C41536l.m120489i(str5, "processReference");
        C41536l.m120489i(str6, "tmxSessionId");
        return new PasscodeLoginQuery(str, str2, str3, str4, str5, str6);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PasscodeLoginQuery)) {
            return false;
        }
        PasscodeLoginQuery passcodeLoginQuery = (PasscodeLoginQuery) obj;
        return C41536l.m120484d(this.username, passcodeLoginQuery.username) && C41536l.m120484d(this.passcode, passcodeLoginQuery.passcode) && C41536l.m120484d(this.authToken, passcodeLoginQuery.authToken) && C41536l.m120484d(this.deviceId, passcodeLoginQuery.deviceId) && C41536l.m120484d(this.processReference, passcodeLoginQuery.processReference) && C41536l.m120484d(this.tmxSessionId, passcodeLoginQuery.tmxSessionId);
    }
    ...
    public int hashCode() {
        return (((((((((this.username.hashCode() * 31) + this.passcode.hashCode()) * 31) + this.authToken.hashCode()) * 31) + this.deviceId.hashCode()) * 31) + this.processReference.hashCode()) * 31) + this.tmxSessionId.hashCode();
    }
    ...
    public C8120m responseFieldMapper() {
        C8120m.C8121a aVar = C8120m.f23272a;
        return new PasscodeLoginQuery$responseFieldMapper$$inlined$invoke$1();
    }

    public String toString() {
        return "PasscodeLoginQuery(username=" + this.username + ", passcode=" + this.passcode + ", authToken=" + this.authToken + ", deviceId=" + this.deviceId + ", processReference=" + this.processReference + ", tmxSessionId=" + this.tmxSessionId + ')';
    }
    ...
    public static final class Login {
        ...
        public static final class Companion {
            ...
            public final C8120m Mapper() {
                C8120m.C8121a aVar = C8120m.f23272a;
                return new PasscodeLoginQuery$Login$Companion$Mapper$$inlined$invoke$1();
            }
        ...
        public static final class Fragments {
            ...
            public static final class Companion {
                ...
                public final C8120m Mapper() {
                    C8120m.C8121a aVar = C8120m.f23272a;
                    return new C42814x8351d49a();
                }

                public final Fragments invoke(C8124o oVar) {
                    C41536l.m120489i(oVar, "reader");
                    Object d = oVar.mo19021d(Fragments.RESPONSE_FIELDS[0], C42816xec997e40.INSTANCE);
                    C41536l.m120486f(d);
            ...
            public final C8122n marshaller() {
                C8122n.C8123a aVar = C8122n.f23274a;
                return new PasscodeLoginQuery$Login$Fragments$marshaller$$inlined$invoke$1(this);
            }
        ...
        public final C8122n marshaller() {
            C8122n.C8123a aVar = C8122n.f23274a;
            return new PasscodeLoginQuery$Login$marshaller$$inlined$invoke$1(this);
        }
    ...
    public static final class LoginServices {
        ...
        public final C8122n marshaller() {
            C8122n.C8123a aVar = C8122n.f23274a;
            return new PasscodeLoginQuery$LoginServices$marshaller$$inlined$invoke$1(this);
        }
