...
public final class ProlongPasswordQuery implements C7842i {
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    public static final String OPERATION_ID = "1d44f7c795c8ec25c27dc463e639d1ffc441f739b461931bee228793c2c8e793";
    /* access modifiers changed from: private */
    public static final C7841h OPERATION_NAME = new ProlongPasswordQuery$Companion$OPERATION_NAME$1();
    /* access modifiers changed from: private */
    public static final String QUERY_DOCUMENT = C8118k.m30683a("query prolongPasswordQuery($processReference:String!) {\n  loginServices {\n    __typename\n    prolongPassword(request: {processReference: $processReference})\n  }\n}");
    private final String processReference;
    private final transient C7836g.C7839c variables = new ProlongPasswordQuery$variables$1(this);
    ...
    public static final class Companion {
        ...
        public final C7841h getOPERATION_NAME() {
            return ProlongPasswordQuery.OPERATION_NAME;
        }

        public final String getQUERY_DOCUMENT() {
            return ProlongPasswordQuery.QUERY_DOCUMENT;
        }
    }
    ...
    public static final class Data implements C7836g.C7838b {
        ...
        public static final class Companion {
            ...
            public final C8120m Mapper() {
                ...
                return new ProlongPasswordQuery$Data$Companion$Mapper$$inlined$invoke$1();
            }

            public final Data invoke(C8124o oVar) {
                C41536l.m120489i(oVar, "reader");
                return new Data((LoginServices) oVar.mo19023f(Data.RESPONSE_FIELDS[0], ProlongPasswordQuery$Data$Companion$invoke$1$loginServices$1.INSTANCE));
            }
        }
        ...
        public C8122n marshaller() {
            ...
            return new ProlongPasswordQuery$Data$marshaller$$inlined$invoke$1(this);
        }
    ...
    public ProlongPasswordQuery(String str) {
        C41536l.m120489i(str, "processReference");
        this.processReference = str;
    }

    public static /* synthetic */ ProlongPasswordQuery copy$default(ProlongPasswordQuery prolongPasswordQuery, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = prolongPasswordQuery.processReference;
        }
        return prolongPasswordQuery.copy(str);
    }
    ...
    public final ProlongPasswordQuery copy(String str) {
        C41536l.m120489i(str, "processReference");
        return new ProlongPasswordQuery(str);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ProlongPasswordQuery) && C41536l.m120484d(this.processReference, ((ProlongPasswordQuery) obj).processReference);
    }
    ...
    public C8120m responseFieldMapper() {
        C8120m.C8121a aVar = C8120m.f23272a;
        return new ProlongPasswordQuery$responseFieldMapper$$inlined$invoke$1();
    }

    public String toString() {
        return "ProlongPasswordQuery(processReference=" + this.processReference + ')';
    }
    ...
    public static final class LoginServices {
        ...
        private final String prolongPassword;
        ...
        static {
            ...
            RESPONSE_FIELDS = new C7846k[]{aVar.mo22817h("__typename", "__typename", (Map) null, false, (List) null), aVar.mo22817h("prolongPassword", "prolongPassword", C41342q0.m119922g(C41233s.m119492a("request", C41342q0.m119922g(C41233s.m119492a("processReference", C41344r0.m119931m(C41233s.m119492a("kind", "Variable"), C41233s.m119492a("variableName", "processReference")))))), true, (List) null)};
        }

        public LoginServices(String str, String str2) {
            C41536l.m120489i(str, "__typename");
            this.__typename = str;
            this.prolongPassword = str2;
        }
        ...
        public static /* synthetic */ LoginServices copy$default(LoginServices loginServices, String str, String str2, int i, Object obj) {
            ...
            if ((i & 2) != 0) {
                str2 = loginServices.prolongPassword;
            }
        ...
        public boolean equals(Object obj) {
            ...
            return C41536l.m120484d(this.__typename, loginServices.__typename) && C41536l.m120484d(this.prolongPassword, loginServices.prolongPassword);
        }

        public final String getProlongPassword() {
            return this.prolongPassword;
        }
        ...
        public int hashCode() {
            ...
            String str = this.prolongPassword;
            return hashCode + (str == null ? 0 : str.hashCode());
        }

        public final C8122n marshaller() {
            C8122n.C8123a aVar = C8122n.f23274a;
            return new ProlongPasswordQuery$LoginServices$marshaller$$inlined$invoke$1(this);
        }

        public String toString() {
            return "LoginServices(__typename=" + this.__typename + ", prolongPassword=" + this.prolongPassword + ')';
        }
