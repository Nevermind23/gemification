...
public final class UploadProfilePictureQuery implements C7842i {
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    public static final String OPERATION_ID = "baef7d03f292c5e46aa020690ecb8657b142302ee6d42501a24dce194e240424";
    /* access modifiers changed from: private */
    public static final C7841h OPERATION_NAME = new UploadProfilePictureQuery$Companion$OPERATION_NAME$1();
    /* access modifiers changed from: private */
    public static final String QUERY_DOCUMENT = C8118k.m30683a("query uploadProfilePicture($profilePictureBase64: String!) {\n  commonServices {\n    __typename\n    uploadProfilePicture(request: {profilePictureBase64: $profilePictureBase64})\n  }\n}");
    private final String profilePictureBase64;
    private final transient C7836g.C7839c variables = new UploadProfilePictureQuery$variables$1(this);
    ...
    public static final class Companion {
        ...
        public final C7841h getOPERATION_NAME() {
            return UploadProfilePictureQuery.OPERATION_NAME;
        }

        public final String getQUERY_DOCUMENT() {
            return UploadProfilePictureQuery.QUERY_DOCUMENT;
        }
    }
    ...
    public static final class Data implements C7836g.C7838b {
        ...
        public static final class Companion {
            ...
            public final C8120m Mapper() {
                ...
                return new C42899x90fd213f();
            }

            public final Data invoke(C8124o oVar) {
                C41536l.m120489i(oVar, "reader");
                return new Data((CommonServices) oVar.mo19023f(Data.RESPONSE_FIELDS[0], C42901xfd086f75.INSTANCE));
            }
        }
        ...
        public C8122n marshaller() {
            ...
            return new UploadProfilePictureQuery$Data$marshaller$$inlined$invoke$1(this);
        }
    ...
    public UploadProfilePictureQuery(String str) {
        C41536l.m120489i(str, "profilePictureBase64");
        this.profilePictureBase64 = str;
    }

    public static /* synthetic */ UploadProfilePictureQuery copy$default(UploadProfilePictureQuery uploadProfilePictureQuery, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            str = uploadProfilePictureQuery.profilePictureBase64;
        }
        return uploadProfilePictureQuery.copy(str);
    }
    ...
    public final UploadProfilePictureQuery copy(String str) {
        C41536l.m120489i(str, "profilePictureBase64");
        return new UploadProfilePictureQuery(str);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UploadProfilePictureQuery) && C41536l.m120484d(this.profilePictureBase64, ((UploadProfilePictureQuery) obj).profilePictureBase64);
    }
    ...
    public int hashCode() {
        return this.profilePictureBase64.hashCode();
    }
    ...
    public C8120m responseFieldMapper() {
        C8120m.C8121a aVar = C8120m.f23272a;
        return new UploadProfilePictureQuery$responseFieldMapper$$inlined$invoke$1();
    }

    public String toString() {
        return "UploadProfilePictureQuery(profilePictureBase64=" + this.profilePictureBase64 + ')';
    }
    ...
    public static final class CommonServices {
        ...
        private final String uploadProfilePicture;
        ...
        static {
            ...
            RESPONSE_FIELDS = new C7846k[]{aVar.mo22817h("__typename", "__typename", (Map) null, false, (List) null), aVar.mo22817h("uploadProfilePicture", "uploadProfilePicture", C41342q0.m119922g(C41233s.m119492a("request", C41342q0.m119922g(C41233s.m119492a("profilePictureBase64", C41344r0.m119931m(C41233s.m119492a("kind", "Variable"), C41233s.m119492a("variableName", "profilePictureBase64")))))), true, (List) null)};
        }

        public CommonServices(String str, String str2) {
            C41536l.m120489i(str, "__typename");
            this.__typename = str;
            this.uploadProfilePicture = str2;
        }
        ...
        public static /* synthetic */ CommonServices copy$default(CommonServices commonServices, String str, String str2, int i, Object obj) {
            ...
            if ((i & 2) != 0) {
                str2 = commonServices.uploadProfilePicture;
            }
        ...
        public boolean equals(Object obj) {
            ...
            return C41536l.m120484d(this.__typename, commonServices.__typename) && C41536l.m120484d(this.uploadProfilePicture, commonServices.uploadProfilePicture);
        }

        public final String getUploadProfilePicture() {
            return this.uploadProfilePicture;
        }
        ...
        public int hashCode() {
            ...
            String str = this.uploadProfilePicture;
            return hashCode + (str == null ? 0 : str.hashCode());
        }

        public final C8122n marshaller() {
            C8122n.C8123a aVar = C8122n.f23274a;
            return new C42898xd49dec82(this);
        }

        public String toString() {
            return "CommonServices(__typename=" + this.__typename + ", uploadProfilePicture=" + this.uploadProfilePicture + ')';
        }
