...
public final class UpdateUsernameQuery implements C7842i {
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    public static final String OPERATION_ID = "b1113d33ceb77c14ecf1652667fdac582d801913512481e8a7aa92e652d72d79";
    /* access modifiers changed from: private */
    public static final C7841h OPERATION_NAME = new UpdateUsernameQuery$Companion$OPERATION_NAME$1();
    /* access modifiers changed from: private */
    public static final String QUERY_DOCUMENT = C8118k.m30683a("query updateUsername($request: InputUpdateUsernameRequest) {\n  loginServices {\n    __typename\n    updateUsername(request: $request)\n  }\n}");
    private final C7833e request;
    ...
    public static final class Companion {
        ...
        public final C7841h getOPERATION_NAME() {
            return UpdateUsernameQuery.OPERATION_NAME;
        }

        public final String getQUERY_DOCUMENT() {
            return UpdateUsernameQuery.QUERY_DOCUMENT;
        }
    }
    ...
    public static final class Data implements C7836g.C7838b {
        ...
        public static final class Companion {
            ...
            public final C8120m Mapper() {
                ...
                return new UpdateUsernameQuery$Data$Companion$Mapper$$inlined$invoke$1();
            }

            public final Data invoke(C8124o oVar) {
                C41536l.m120489i(oVar, "reader");
                return new Data((LoginServices) oVar.mo19023f(Data.RESPONSE_FIELDS[0], UpdateUsernameQuery$Data$Companion$invoke$1$loginServices$1.INSTANCE));
            }
        }
        ...
        public C8122n marshaller() {
            ...
            return new UpdateUsernameQuery$Data$marshaller$$inlined$invoke$1(this);
        }
    ...
    public UpdateUsernameQuery() {
        this((C7833e) null, 1, (DefaultConstructorMarker) null);
    }

    public static /* synthetic */ UpdateUsernameQuery copy$default(UpdateUsernameQuery updateUsernameQuery, C7833e eVar, int i, Object obj) {
        if ((i & 1) != 0) {
            eVar = updateUsernameQuery.request;
        }
        return updateUsernameQuery.copy(eVar);
    }
    ...
    public final UpdateUsernameQuery copy(C7833e eVar) {
        C41536l.m120489i(eVar, "request");
        return new UpdateUsernameQuery(eVar);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UpdateUsernameQuery) && C41536l.m120484d(this.request, ((UpdateUsernameQuery) obj).request);
    }

    public final C7833e getRequest() {
        return this.request;
    }
    ...
    public C8120m responseFieldMapper() {
        C8120m.C8121a aVar = C8120m.f23272a;
        return new UpdateUsernameQuery$responseFieldMapper$$inlined$invoke$1();
    }

    public String toString() {
        return "UpdateUsernameQuery(request=" + this.request + ')';
    }
    ...
    public UpdateUsernameQuery(C7833e eVar) {
        C41536l.m120489i(eVar, "request");
        this.request = eVar;
        this.variables = new UpdateUsernameQuery$variables$1(this);
    }
    ...
    public static final class LoginServices {
        ...
        static {
            ...
            RESPONSE_FIELDS = new C7846k[]{aVar.mo22817h("__typename", "__typename", (Map) null, false, (List) null), aVar.mo22817h("updateUsername", "updateUsername", C41342q0.m119922g(C41233s.m119492a("request", C41344r0.m119931m(C41233s.m119492a("kind", "Variable"), C41233s.m119492a("variableName", "request")))), true, (List) null)};
        }
        ...
        public static /* synthetic */ LoginServices copy$default(LoginServices loginServices, String str, String str2, int i, Object obj) {
            ...
            if ((i & 2) != 0) {
                str2 = loginServices.updateUsername;
            }
        ...
        public boolean equals(Object obj) {
            ...
            return C41536l.m120484d(this.__typename, loginServices.__typename) && C41536l.m120484d(this.updateUsername, loginServices.updateUsername);
        }
        ...
        public final C8122n marshaller() {
            C8122n.C8123a aVar = C8122n.f23274a;
            return new UpdateUsernameQuery$LoginServices$marshaller$$inlined$invoke$1(this);
        }

        public String toString() {
            return "LoginServices(__typename=" + this.__typename + ", updateUsername=" + this.updateUsername + ')';
        }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ UpdateUsernameQuery(C7833e eVar, int i, DefaultConstructorMarker defaultConstructorMarker) {
