...
/* renamed from: ni0.c */
public final class C26503c implements C26241e {

    /* renamed from: a */
    public static final C26503c f67094a = new C26503c();
    ...
    /* renamed from: a */
    public int mo47487a() {
        return C27011f.item_gift_card_transaction_date;
    }
    ...
    public C26238b mo47488b(LayoutInflater layoutInflater, ViewGroup viewGroup, C26234b bVar) {
        ...
        C28417o0 d = C28417o0.m87190d(LayoutInflater.from(viewGroup.getContext()), viewGroup, false);
        C41536l.m120488h(d, "inflate(LayoutInflater.f….context), parent, false)");
        return new C27819f(d);
    }
    ...
    public boolean mo47490d(C27534a aVar) {
        ...
        return aVar instanceof C27534a.C27537c;
    }
}
